...
class AiGuardrails < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/gautampachnanda101/homebrew-tap/releases/download/v0.2.0/ai-guardrails_0.2.0_Darwin_x86_64.tar.gz"
      sha256 "8d6cdf8d2c546c6f335d7504f9cf9351bccbb087319b732fb7badf8ffd4b96e1"
    end

    on_arm do
      url "https://github.com/gautampachnanda101/homebrew-tap/releases/download/v0.2.0/ai-guardrails_0.2.0_Darwin_arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/gautampachnanda101/homebrew-tap/releases/download/v0.2.0/ai-guardrails_0.2.0_Linux_x86_64.tar.gz"
    ...
    on_arm do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/gautampachnanda101/homebrew-tap/releases/download/v0.2.0/ai-guardrails_0.2.0_Linux_arm64.tar.gz"
